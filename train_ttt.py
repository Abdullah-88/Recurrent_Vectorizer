...
from vectorizer_ttt import Vectorizer
...
class VectorizerImageClassification(Vectorizer):
    def __init__(
        self,
        image_size=32,
        patch_size=4,
...
model = VectorizerImageClassification().to(device)
print(model)
...
logname = "/PATH/Recurrent_Vectorizer_TTT/Experiments_cifar10/logs_vectorizer/logs_cifar10.csv"
...
path = "/PATH/Recurrent_Vectorizer_TTT/Experiments_cifar10/weights_vectorizer"
